...
; NOTE: Disable default highlighting of template strings. I have a customized
...
; NOTE: In order for emmet to work in styled-components, we have to setup
; highlight groups that we can check. These are replicated from the injections.
