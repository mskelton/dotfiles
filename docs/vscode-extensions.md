...
cursor --install-extension jnoortheen.nix-ide
...
cursor --install-extension mskelton.notify
...
cursor --install-extension plorefice.devicetree
cursor --install-extension plorefice.devicetree
...
cursor --install-extension undefined_publisher.vscode-dtsfmt
